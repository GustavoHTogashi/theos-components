...
import { TIPO_CONTATO } from './theos-input-fiel.constants';
import { TheosContact } from './theos-input-fiel.interface';
import { theosInputFielService } from './theos-input-fiel.service';


@Component({
  selector: 'theos-input-fiel',
  templateUrl: './theos-input-fiel.component.html',
  styleUrls: ['./theos-input-fiel.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TheostheosInputFielComponent implements OnInit, OnDestroy {
  @Input() customMask = null;
  @Input() customMaskDropSpecialCharacters = true;
  @Input() id = 'THContact';
  ...
  @ViewChild('thInput', { static: false }) input: ElementRef;
  ...
  constructor(
    ...
    private _contact: theosInputFielService
  ) {
